...
\chapter{まとめ}
	PC版シミュレータとiOS版シミュレータの2種類を作成
	先行研究のシミュレータと同じものは再現できなかったが
	入力インターフェースと3Dモデルおよびオブジェクト保持アニメーション
	の違いから
\chapter{今後の課題}
	FirstVRの性能評価が不十分
	ジェスチャ判別の閾値についてsample数以外の観点で調べるべき
	・装着位置
	・筋肉量
	・男女比の均衡
	・学習時間の違い
...
\chapter*{謝辞}
一年間丁寧に指導していただいた戸崎先生，および同研究室の村岡氏
