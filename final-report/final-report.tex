...
\vspace{-15pt}
	...
	\section{FirstVRの性能評価手法}
		...
		FirstVRの評価基準としてジェスチャ認識率と独自の評価指標による性能評価を行なった．
...
\clearpage
		表\refeq{tab:FVRdata}の各sample数における分散を図\refeq{fig:FVRdata}に示す.
...
\clearpage
	...
	\section{シミュレータの定性評価}
		...
		\end{figure}
		\vspace{-15pt}
		PC版の平均値 3.36点 中央値4点 最高値5点 最低値1点 標本分散
		iOS版の平均値 3.90点 中央値4点 最高値6点 最低値1点 標本分散
		...
		\label{fig:sousasei}
		\end{figure}
		PC版の平均値 3.09点 中央値3点 最高値5点 最低値2点 標本分散
		iOS版の平均値 点 中央値3点 最高値6点 最低値1点 標本分散
		...
		\end{figure}
		\vspace{-15pt}
		PC版の平均値 3.09点 中央値は3点 最高値5点 最低値2点 標本分散
		iOS版の平均値 3.90点 中央値は4点 最高値6点 最低値1点 標本分散
