...
\chapter{序論}
	...
	また，近年では``カグラ''\cite{ref:3}という製品は上肢機能障害者
...
\clearpage
	...
	\section{FirstVR}
		...
		この製品は現状iOSとAndroidのみ対応しており、アプリケーション開発をする際は
		\subsection{デバイス構成}
				\begin{figure}[H]
				\centering
				...
				\end{figure}
		\subsection{トラッキング}
			FirtVRには3軸ジャイロセンサと加速度センサが搭載されており，Unityで作製したアプリ上で測定値を確認することができる．
			本研究ではこのジャイロセンサを用いて，腕のピッチ，ヨー，ロールの3軸の回転をシミュレータに反映させている．
		\subsection{ジェスチャ認識}
			FirstVRのジェスチャ認識方法は、ジェスチャ状態と非ジェスチャ状態における筋変位センサの各チャンネルごとの値をサンプリングし、
...
\chapter{研究結果}
	\section{FirstVR}
		...
		\begin{figure}[H]
		\centering
		\includegraphics[width = 12cm]{../figs/IMG_1386.JPG}
		\caption{}
		\label{}
		\end{figure}
		...
		\begin{minipage}{0.4\columnwidth}
		\centering
		\includegraphics[width = \columnwidth]{../figs/IMG_5139.PNG}
		\end{minipage}
		\caption{}
		\end{figure}
